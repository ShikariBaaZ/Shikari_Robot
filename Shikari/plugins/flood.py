...
from Shikari.mongo.flooddb import *
from Shikari.utils.filter_groups import flood_group
...
Anti-Function is the inbuilt toolkit in Shikari for avoid spammers, and to improve Anti-Function of your group"""
__helpbtns__ = (
        [[
            InlineKeyboardButton
                (
