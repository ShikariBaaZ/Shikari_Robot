...
from Shikari.utils.caching import ADMIN_CACHE, TEMP_ADMIN_CACHE_BLOCK, admin_cache_reload
...
from pyrogram import filters
from pyrogram.types import Message
from Shikari.plugins.rules import *
from Shikari import BOT_ID, app
from Shikari.utils.functions import extract_user
...
Sometimes, you promote or demote an admin manually, and Shikari doesn't realise it immediately. This is because to avoid spamming telegram servers, admin status is cached locally.
...
that'll force Shikari to check who the admins are again. 
"""
