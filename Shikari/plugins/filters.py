...
from Shikari.utils.custom_filters import command, owner_filter
from Shikari.utils.kbhelpers import rkb as ikb
from Shikari.utils.msg_types import Types, get_filter_type
from Shikari.utils.regex_utils import regex_searcher
...
Filters are case insensitive; every time someone says your trigger words, Shikari will reply something else! can be used to create your own commands, if desired.
