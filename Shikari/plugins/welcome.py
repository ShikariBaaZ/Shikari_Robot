...
from Shikari import *
from Shikari.mongo.gban import GBan
from Shikari.mongo.welcomedb import Greetings
from Shikari.utils.custom_filters import admin_filter, command
...
from Shikari.mongo.feddb import (get_fed_from_chat,
...
my news channel @The_SHIKARI_Network.

**New to Me, Touch the below button and start me in PM**
                    """,
                    reply_markup=InlineKeyboardMarkup(
            [
                InlineKeyboardButton("quick start guide", url="http://t.me/Shikaribot?start=help"),
            ]))
